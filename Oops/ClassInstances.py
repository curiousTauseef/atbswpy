...
class Manager(Employee):
    ...
    # we dont pass list here, avoid passing mutable objects
    def __init__(self, first, last, pay, employ=None):
        super().__init__(first, last, pay)
...
# inside here pass any instance as an argument (self))
Employee.applyRaise(emp2)
...
# we have redefined dunder add method to add pays of two Employees
print(emp1 + emp2)
